export const postResenna = async (resenna) => {
    try {
        ...
        const response = await fetch("http://https://appresennas.netlify.app/resennas", {
            method: 'POST',
...
export const deleteResennna = async (resenna) => {
    const response = await fetch("http://https://appresennas.netlify.app/resennas/" + resenna.id, {
        method: "DELETE"
    });
...
export const getResennaOne = async (resennaId) => {
    const response = await fetch(`http://https://appresennas.netlify.app/resennas/${resennaId}`);
    return await response.json();
};
